/******************************************************************
*
*$RCSfile: StringUtils.java,v $ $Revision: 1.7 $ $Author: Administrator $ $Date: 2006/03/13 01:03:54 $
*
*$Log: StringUtils.java,v $
*Revision 1.7  2006/03/13 01:03:54  Administrator
*no message
*
*Revision 1.6  2006/01/07 11:47:34  Administrator
*no message
*
*Revision 1.5  2005/12/18 14:06:17  Administrator
*no message
*
*Revision 1.4  2005/09/14 01:53:00  Administrator
*no message
*
*Revision 1.3  2005/06/16 10:19:20  Administrator
*no message
*
...
*init
*
*Revision 1.4  2003/09/29 07:37:24  yfzhu
*before removing entity beans
*
*Revision 1.3  2003/08/17 14:25:11  yfzhu
*before adv security
*
...
*/
	...
	public static String shortenInBytes(String s, int bytes, String suffix) {
		if (s == null || "".equals(s) )  {
			return "";
		}
		int len= s.length();
		int b= s.getBytes().length;
		return StringUtils.shorten(s,(int) ((bytes*len)/b), suffix);
		
	}	
	public static String shortenInBytes(String s, int bytes) {
		return shortenInBytes(s, bytes,".");
	}
	/**
	 * replace ",; " with "|"
	 * @param s
	 ...
	 */
	public static String replaceToken(String s, String tokens, String newSeperator){
		StringTokenizer st=new StringTokenizer(s, tokens);
		StringBuffer sb=new StringBuffer();
		if (st.hasMoreTokens()) sb.append(st.nextToken());
		while(st.hasMoreTokens()){
			sb.append(newSeperator);
			sb.append(st.nextToken());
		}
		return sb.toString();
	}	
	/**
	 * Get root cause message of throwable
	 * @param t
	 * @return
	 */

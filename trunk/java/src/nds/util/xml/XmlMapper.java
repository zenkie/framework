/******************************************************************
*
*$RCSfile: XmlMapper.java,v $ $Revision: 1.1.1.1 $ $Author: Administrator $ $Date: 2005/03/15 11:23:27 $
*
*$Log: XmlMapper.java,v $
*Revision 1.1.1.1  2005/03/15 11:23:27  Administrator
*init
*
*Revision 1.2  2003/05/29 19:40:13  yfzhu
*<No Comment Entered>
*
...
class AddChild extends XmlAction {
	...
	if( paramT==null) {
        ...
        }catch(NoSuchMethodException eer){
            System.out.println("Error no such method:"+ parentM +"("+ params+")");
            throw eer;
        }
    }
}

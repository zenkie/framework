...
//----------------------------------------------------------------------------
//$Id: Util.java,v 1.1 2006/01/07 11:46:35 Administrator Exp $
//
...
public class Util {
	 ...
	 * array is used. If <code>m</code> is omitted, nothing is prepended to
	 * each line.
	 * </p>
	 * 
	 * @param data
	 ...
	 *             if <code>str</code> is <code>null</code>, or
	 ...
	 */
	/*
	 * public static final byte[] trim(BigInteger n) { byte[] in =
	 * n.toByteArray(); if (in.length == 0 || in[0] != 0) { return in; } int len =
	 * in.length; int i = 1; while (in[i] == 0 && i < len) { ++i; } byte[]
	 * result = new byte[len - i]; System.arraycopy(in, i, result, 0, len - i);
	 * return result; }
	 */
	 ...
	 */
	/*
	 * public static final String dump(BigInteger x) { return
	 * dumpString(trim(x)); }
	 */

...
// ----------------------------------------------------------------------------
// $Id: Sha512.java,v 1.1 2006/01/07 11:46:35 Administrator Exp $
//
 ...
 * <ol>
 * <li><a
 * href="http://ftp.ipv4.heanet.ie/pub/ietf/internet-drafts/draft-ietf-ipsec-ciph-aes-cbc-03.txt">
...
public class Sha512 extends BaseHash {
	...
	private Sha512(Sha512 md) {
		...
		this.h7 = md.h7;
		this.count = md.count;
		// yfzhu modified since byte[] not support clone
		//this.buffer = (byte[]) md.buffer.clone();
		this.buffer = new byte[md.buffer.length];
		for (int i = 0; i < md.buffer.length; i++)
			this.buffer[i] = md.buffer[i];

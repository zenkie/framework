...
/*
 * Copied from org.apache.velocity.tools.view.servlet.WebappLoader 
 */
 ...
 * @version $Id: WebappLoader.java 479724 2006-11-27 18:49:37Z nbubna $  */

public class WebappLoader extends ResourceLoader
{
	private static final Log logger = LogFactory.getLog(WebappLoader.class);	
    ...
    {
        logger.debug("WebappLoader : initialization starting.");
        ...
        else
        {
            ...
            for (int i=0; i < paths.length; i++)
            {
                ...
                logger.info("WebappLoader : added template path - '" + paths[i] + "'");
            }
        }
        ...
        {
            logger.error("WebappLoader : unable to retrieve ServletContext");
        }

        /* init the template paths map */
        templatePaths = new HashMap();

        logger.debug("WebappLoader : initialization complete.");
    }

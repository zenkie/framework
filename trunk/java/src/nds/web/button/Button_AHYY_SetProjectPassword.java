 ...
 * …Ë÷√œµÕ≥√‹¬Î
 */
public class Button_AHYY_SetProjectPassword extends ButtonCommandUI_Impl{
	/**
	...
	protected String getHandleURL(HttpServletRequest request, Column column, int objectId){
		...
		append(WebKeys.NDS_URI+ "/ahyy/setprjpasswd.jsp?columnid="+ column.getId()+"&objectid=").append(objectId);
		return sb.toString();
	}
	/**
	 * Popup type

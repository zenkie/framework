 ...
 * For groups table
 */
public class ButtonSetGroupPerms extends ButtonCommandUI_Impl{
	/**
	...
	protected String getHandleURL(HttpServletRequest request, Column column, int objectId){
		...
		append(WebKeys.NDS_URI+ "/security/grouperm_subsystem.jsp?id=").append(objectId).append("&table=").append(tableId);
		return sb.toString();
	}
	/**
	 * Popup type

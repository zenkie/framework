...
/**
 * 
取Y_PLAN_ITEM中的M_PROCUT_ID，如该列不为NULL，则不显示按钮。
否则点击按钮时根据Y_PLAN_ITEM表中的Y_PLAN_ID取到Y_PLAN表中LIST_TYPE的值
如为FAB，则打开视图Y_PLAN_ALLOT_FAB，如为ACC，则打开视图Y_PLAN_ALLOT_ACC。
 * @author yfzhu
 *
 */

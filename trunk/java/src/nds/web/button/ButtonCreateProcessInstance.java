...
/**
 * For AD_PROCESS TABLE to Create ad_pinstance
 */
public class ButtonCreateProcessInstance extends ButtonCommandUI_Impl{
	/**
	...
	protected String getHandleURL(HttpServletRequest request, Column column, int objectId){
		...
		append(WebKeys.NDS_URI+ "/schedule/addpi.jsp?id=").append(objectId);
		return sb.toString();
	}
	/**
	 * Popup type

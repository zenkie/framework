...
public class InvoiceStatusInterpreter implements ColumnInterpreter,java.io.Serializable {
    public InvoiceStatusInterpreter() {}
    /** Valid part are 
     *  2 finish
    ...
    public String parseValue(Object value,Locale locale) {
    	...
    	for (int i=0;i<s.length;i++){
    		r += "<img src='"+ WebKeys.NDS_URI+"/images/status/invoice_"+ s[i]+".gif' width=16 height=16 align=absmiddle border=0>";
    	}
        return r;
    }
    /**

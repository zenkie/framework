 ...
 *
 * @hibernate.class
 *  table="AD_TABLECATEGORY"
 */
public abstract class BaseAdTableCategory  implements Serializable {

	public static String PROP_IS_ACTIVE = "IsActive";
	public static String PROP_AD_CLIENT_ID = "AdClientId";
	public static String PROP_AD_SUBSYSTEM_ID = "AdSubSystemId";
	...
	private java.lang.Integer _adSubSystemId;
	...
	// collections
	private java.util.Set _adTableSet;


	// constructors
	public BaseAdTableCategory () {
		initialize();
	}
	 ...
	 */
	public BaseAdTableCategory (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	public java.lang.Integer getAdSubSystemId () {
		return _adSubSystemId;
	}
	 ...
	 * @param _adClientId the AD_CLIENT_ID value
	 */
	public void setAdSubSystemId (java.lang.Integer _adSubSystemId) {
		this._adSubSystemId = _adSubSystemId;
	}
	/**
     * @hibernate.property
     *  column=AD_SUBSYSTEM_ID
	 * not-null=false
	 */
	public nds.model.AdSubSystem getAdSubSystem () {
		return this._adSubSystem;
	}
	 ...
	 */
	public void setAdSubSystem (nds.model.AdSubSystem _adSubSystem) {
		this._adSubSystem = _adSubSystem;
	}	
	/**
	...
	/**
	 * Return the value associated with the column: AdTableSet
	 */
	public java.util.Set getAdTableSet () {
		return this._adTableSet;
	}

	/**
	 * Set the value related to the column: AdTableSet
	 * @param _adTableSet the AdTableSet value
	 */
	public void setAdTableSet (java.util.Set _adTableSet) {
		this._adTableSet = _adTableSet;
	}
	
	public void addToAdTableSet (Object obj) {
		if (null == this._adTableSet) this._adTableSet = new java.util.HashSet();
		this._adTableSet.add(obj);
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof nds.model.base.BaseAdTableCategory)) return false;
		else {
			nds.model.base.BaseAdTableCategory mObj = (nds.model.base.BaseAdTableCategory) obj;

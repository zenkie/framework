 ...
 *
 * This is an object that contains data related to the AD_LIMITVALUE_GROUP table.
 ...
 */
public abstract class BaseAdLimitValueGroup  implements Serializable {
	...
	// collections
	private java.util.Set _adLimitValueSet;
	private java.util.Set _adColumnSet;


	// constructors
	public BaseAdLimitValueGroup () {
		initialize();
	}
	 ...
	 */
	public BaseAdLimitValueGroup (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: AdLimitValueSet
	 */
	public java.util.Set getAdLimitValueSet () {
		return this._adLimitValueSet;
	}

	/**
	 * Set the value related to the column: AdLimitValueSet
	 * @param _adLimitValueSet the AdLimitValueSet value
	 */
	public void setAdLimitValueSet (java.util.Set _adLimitValueSet) {
		this._adLimitValueSet = _adLimitValueSet;
	}
	
	public void addToAdLimitValueSet (Object obj) {
		if (null == this._adLimitValueSet) this._adLimitValueSet = new java.util.HashSet();
		this._adLimitValueSet.add(obj);
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof nds.model.base.BaseAdLimitValueGroup)) return false;
		else {
			nds.model.base.BaseAdLimitValueGroup mObj = (nds.model.base.BaseAdLimitValueGroup) obj;

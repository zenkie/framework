 ...
 *
 * This is an object that contains data related to the M_ATTRIBUTE table.
 ...
 *  table="M_ATTRIBUTE"
 */
public abstract class BaseMAttribute  implements Serializable {

	public static String PROP_ATTRIBUTE_VALUE_TYPE = "AttributeValueType";
	...
	public static String PROP_IS_MANDATORY = "IsMandatory";
	...
	private java.lang.String _attributeValueType;
	 ...
	 */
	public BaseMAttribute (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	public BaseMAttribute (
		...
		this.setAttributeValueType(_attributeValueType);
		this.setIsMandatory(_isMandatory);
	...
	/**
	 * Return the value associated with the column: ATTRIBUTEVALUETYPE
	 */
	public java.lang.String getAttributeValueType () {
		return _attributeValueType;
	}

	/**
	 * Set the value related to the column: ATTRIBUTEVALUETYPE
	 * @param _attributeValueType the ATTRIBUTEVALUETYPE value
	 */
	public void setAttributeValueType (java.lang.String _attributeValueType) {
		this._attributeValueType = _attributeValueType;
	}


	/**
	 * Return the value associated with the column: ISMANDATORY
	 */
	...
	/**
	 * Set the value related to the column: ISMANDATORY
	 * @param _isMandatory the ISMANDATORY value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof nds.model.base.BaseMAttribute)) return false;
		else {
			nds.model.base.BaseMAttribute mObj = (nds.model.base.BaseMAttribute) obj;

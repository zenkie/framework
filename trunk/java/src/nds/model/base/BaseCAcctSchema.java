 ...
 *
 * This is an object that contains data related to the C_ACCTSCHEMA table.
 ...
 *  table="C_ACCTSCHEMA"
 */
public abstract class BaseCAcctSchema  implements Serializable {

	public static String PROP_SEPARATOR = "Separator";
	 ...
	 */
	public BaseCAcctSchema (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	public BaseCAcctSchema (
		...
		this.setId(_id);
		this.setCCurrency(_cCurrency);
		this.setName(_name);
		this.setCCurrencyId(_cCurrencyId);
	...
	/**
	 * Return the value associated with the column: SEPARATOR
	 */
	 ...
	 * @param _separator the SEPARATOR value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof nds.model.base.BaseCAcctSchema)) return false;
		else {
			nds.model.base.BaseCAcctSchema mObj = (nds.model.base.BaseCAcctSchema) obj;

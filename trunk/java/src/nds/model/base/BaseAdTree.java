 ...
 *
 * This is an object that contains data related to the AD_TREE table.
 ...
 *  table="AD_TREE"
 */
public abstract class BaseAdTree  implements Serializable {
	...
	public static String PROP_TREE_TYPE = "TreeType";
	...
	private java.lang.String _treeType;
	 ...
	 */
	public BaseAdTree (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: TREETYPE
	 */
	...
	/**
	 * Set the value related to the column: TREETYPE
	 * @param _treeType the TREETYPE value
	 */
	public void setTreeType (java.lang.String _treeType) {
		this._treeType = _treeType;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof nds.model.base.BaseAdTree)) return false;
		else {
			nds.model.base.BaseAdTree mObj = (nds.model.base.BaseAdTree) obj;

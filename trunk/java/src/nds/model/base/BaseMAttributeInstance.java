 ...
 *
 * This is an object that contains data related to the M_ATTRIBUTEINSTANCE table.
 ...
 */
public abstract class BaseMAttributeInstance  implements Serializable {

	public static String PROP_IS_ACTIVE = "IsActive";
	public static String PROP_M_ATTRIBUTE_VALUE_ID = "MAttributeValueId";
	public static String PROP_AD_ORG = "AdOrg";
	public static String PROP_M_ATTRIBUTE_VALUE = "MAttributeValue";
	public static String PROP_MODIFIER_ID = "ModifierId";
	public static String PROP_M_ATTRIBUTE_ID = "MAttributeId";
	public static String PROP_VALUE_NUMBER = "ValueNumber";
	...
	private java.lang.Integer _mAttributeValueId;
	private java.lang.String _value;
	private java.lang.Integer _valueNumber;
	...
	private nds.model.MAttributeValue _mAttributeValue;


	// constructors
	public BaseMAttributeInstance () {
		initialize();
	}
	 ...
	 */
	public BaseMAttributeInstance (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	public BaseMAttributeInstance (
		...
		this.setValueNumber(_valueNumber);
	...
	/**
	 * Return the value associated with the column: M_ATTRIBUTEVALUE_ID
	 */
	public java.lang.Integer getMAttributeValueId () {
		return _mAttributeValueId;
	}

	/**
	 * Set the value related to the column: M_ATTRIBUTEVALUE_ID
	 * @param _mAttributeValueId the M_ATTRIBUTEVALUE_ID value
	 */
	public void setMAttributeValueId (java.lang.Integer _mAttributeValueId) {
		this._mAttributeValueId = _mAttributeValueId;
	}
	...
	/**
	 * Return the value associated with the column: VALUENUMBER
	 */
	public java.lang.Integer getValueNumber () {
		return _valueNumber;
	}

	/**
	 * Set the value related to the column: VALUENUMBER
	 * @param _valueNumber the VALUENUMBER value
	 */
	public void setValueNumber (java.lang.Integer _valueNumber) {
		this._valueNumber = _valueNumber;
	}
	 ...
	 */
	public nds.model.MAttributeValue getMAttributeValue () {
		return this._mAttributeValue;
	}

	/**
	 * Set the value related to the column: M_ATTRIBUTEVALUE_ID
	 * @param _mAttributeValue the M_ATTRIBUTEVALUE_ID value
	 */
	public void setMAttributeValue (nds.model.MAttributeValue _mAttributeValue) {
		this._mAttributeValue = _mAttributeValue;
	}


	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof nds.model.base.BaseMAttributeInstance)) return false;
		else {
			nds.model.base.BaseMAttributeInstance mObj = (nds.model.base.BaseMAttributeInstance) obj;

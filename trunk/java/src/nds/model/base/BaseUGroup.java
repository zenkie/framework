 ...
 *
 * This is an object that contains data related to the U_GROUP table.
 ...
 *  table="U_GROUP"
 */
public abstract class BaseUGroup  implements Serializable {
	...
	// collections
	private java.util.Set _uGroupuserSet;
	 ...
	 */
	public BaseUGroup (java.lang.Integer _id) {
		this.setId(_id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: UGroupuserSet
	 */
	public java.util.Set getUGroupuserSet () {
		return this._uGroupuserSet;
	}

	/**
	 * Set the value related to the column: UGroupuserSet
	 * @param _uGroupuserSet the UGroupuserSet value
	 */
	public void setUGroupuserSet (java.util.Set _uGroupuserSet) {
		this._uGroupuserSet = _uGroupuserSet;
	}
	
	public void addToUGroupuserSet (Object obj) {
		if (null == this._uGroupuserSet) this._uGroupuserSet = new java.util.HashSet();
		this._uGroupuserSet.add(obj);
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof nds.model.base.BaseUGroup)) return false;
		else {
			nds.model.base.BaseUGroup mObj = (nds.model.base.BaseUGroup) obj;

...
/**
 * Í¶Æ±×¼±¸
 * call C_PROJECT_PollPrep(projectno)
 */

public class AHYY_PollPrep extends Command {
	/**
	 * @param event
	 */
  public ValueHolder execute(DefaultWebEvent event) throws RemoteException, NDSException {
	...
	try{
		...
		int pid=Tools.getInt(engine.doQueryOne("select id from ad_process where PROCEDURENAME='C_PROJECT_POLLPREP'",conn),-1);
	  	if(pid==-1) 
	  		throw new NDSException("Internal Error: process 'C_PROJECT_POLLPREP' is not found");

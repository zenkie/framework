...
/**
 * Í¶Æ±×¼±¸
 * call C_PROJECT_ScorePrep(projectno)
 */

public class AHYY_ScorePrep extends Command {
	/**
	 * @param event
	 */
  public ValueHolder execute(DefaultWebEvent event) throws RemoteException, NDSException {
	...
	try{
		...
		int pid=Tools.getInt(engine.doQueryOne("select id from ad_process where PROCEDURENAME='C_PROJECT_SCOREPREP'",conn),-1);
	  	if(pid==-1) 
	  		throw new NDSException("Internal Error: process 'C_PROJECT_SCOREPREP' is not found");

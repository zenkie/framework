...
/**
*  Invalid all records selected, if condition ok
*/
public class ListVoid extends Command{
   ...
   * 
   */
  private String voidOne(Table table,int itemid,int userId,Connection con){
      try{
          ...
          String sql= ObjectVoid.getSql(table, itemid, userId);
          logger.debug(sql);

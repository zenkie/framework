...
/**
 * Õ∂∆±≈≈√˚
 * call C_PROJECT_PollCalc(projectno)
 */

public class AHYY_PollCalc extends Command {
	/**
	 * @param event
	 */
  public ValueHolder execute(DefaultWebEvent event) throws RemoteException, NDSException {
	...
	try{
		...
		int pid=Tools.getInt(engine.doQueryOne("select id from ad_process where PROCEDURENAME='C_PROJECT_POLLCALC'",conn),-1);
	  	if(pid==-1) 
	  		throw new NDSException("Internal Error: process 'C_PROJECT_POLLCALC' is not found");

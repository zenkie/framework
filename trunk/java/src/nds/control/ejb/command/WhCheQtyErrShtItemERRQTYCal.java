...
public class WhCheQtyErrShtItemERRQTYCal extends ColumnObtain {

  public WhCheQtyErrShtItemERRQTYCal() {
  }
        ...
        try{
                for(int i = 0;i<length;i++){
                    ...
                    if(res.next() ){
                       ...
                       storage[i] = new BigDecimal(Tools.getBigDecimal(cheStorage[i],true).doubleValue()-0);
                    }
                }
            }catch(Exception e){

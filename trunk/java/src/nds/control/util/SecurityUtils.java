...
public class SecurityUtils {
    ...
    private final static String GET_USER_BY_NAME_AND_CLIENT="select u.id, u.name, u.isactive,u.ad_client_id, u.ad_org_id, u.language, c.name, u.isadmin, u.sgrade from users u, ad_client c where u.name=? and u.ad_client_id=c.id and c.domain=?";
    private final static String GET_USER_BY_EMAIL_AND_CLIENT="select u.id, u.name, u.isactive,u.ad_client_id, u.ad_org_id, u.language, c.name ,u.isadmin, u.sgrade from users u, ad_client c where u.email=? and u.ad_client_id=c.id and c.domain=?";
    private final static String GET_USER_BY_ID="select u.name,c.domain,u.isactive, u.description, u.ad_client_id, u.ad_org_id, u.language, c.name,u.isadmin, u.sgrade from users u,ad_client c where u.ID=? and c.id=u.ad_client_id";
    ...
    public static  User getUser(String userNameOrEmail, String clientName){
    	...
    	try{
	    	...
	    	if(rs.next()){
	    		...
	    		usr.setSecurityGrade(rs.getInt(9));
	    	}
    	}catch(Exception e){
    ...
    public static  User getUser(int userId) throws Exception{
    	...
    	try{
	    	...
	    	if(rs.next()){
	    		...
	    		usr.setSecurityGrade(rs.getInt(10));
	    	}
    	}/*catch(Exception e){

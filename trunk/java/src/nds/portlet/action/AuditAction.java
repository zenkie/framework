...
import java.util.*;
/**
 * Accept or reject on phase instance
 */
public class AuditAction extends PortletAction {
		...
		throws Exception {
			...
			if (cmd.equals(Constants.UPDATE)) {
				...
				try{
			        ...
			        SessionMessages.add(req, "execute_audit", vh.get("message"));
			...
			setForward(req, "portlet.ndsaudit.view");
	}

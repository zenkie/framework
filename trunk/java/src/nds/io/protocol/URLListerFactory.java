...
public class URLListerFactory {
   ...
   static {
      defaultClasses.put("file", "nds.io.protocol.file.FileURLLister");
      defaultClasses.put("http", "nds.io.protocol.http.DavURLLister");
      defaultClasses.put("https", "nds.io.protocol.http.DavURLLister");
   }

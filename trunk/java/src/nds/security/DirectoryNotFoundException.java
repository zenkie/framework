...
public class DirectoryNotFoundException extends nds.util.NDSException {
  public DirectoryNotFoundException() {
    super();
  }
  public DirectoryNotFoundException(String errorMesg) {
    //this.errMesg = errorMesg;
    super(errorMesg);
  }
    public DirectoryNotFoundException(String s, Exception ex) {
    //this.errMesg = errorMesg;
    super(s, ex);
  }
}
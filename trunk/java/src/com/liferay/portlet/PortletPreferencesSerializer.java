/**
	http://bennycho.blogspot.com/2005/06/comliferayportletportletpreferencesser.html
 http://blog.csdn.net/clearwater21cn/archive/2006/11/18/1394383.aspx
 */
...
public class PortletPreferencesSerializer {
	...
	public static String toXML(PortletPreferencesImpl prefs)
		...
		try {
			...
			// yfzhu modified at 2007-10-19
			//ByteArrayOutputStream baos = new ByteArrayOutputStream();
			java.io.StringWriter baos = new java.io.StringWriter();

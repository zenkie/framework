			...
			<div class="right001">
				...
				<div class="right003">
                   ...
                   <!--如果是多选：调用 oq.toggle_m(...return_type=m...)-->
					<span id="dealer_query1_link" title="popup" onaction="oq.toggle_m('/html/nds/query/search.jsp?table=groups&return_type=m&accepter_id=dealer_query1','dealer_query1')">
